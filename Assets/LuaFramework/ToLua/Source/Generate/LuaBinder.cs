...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.BeginModule(null);
		TweenUtilWrap.Register(L);
		NetWorkMgrWrap.Register(L);
		GameMgrWrap.Register(L);
		GlobalDataWrap.Register(L);
		EventMgrWrap.Register(L);
		ScrollViewMgrWrap.Register(L);
		EventTriggerListenerWrap.Register(L);
		LuaInterface_DebuggerWrap.Register(L);
		LuaProfilerWrap.Register(L);
		Singleton_TweenUtilWrap.Register(L);
		...
		L.EndModule();
		L.EndModule();
		L.BeginModule("NetWorkMgr");
		NetWorkMgr_MessageWrap.Register(L);
		NetWorkMgr_PlayerWrap.Register(L);
		L.EndModule();
