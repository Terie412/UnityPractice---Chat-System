...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(EventMgr.EventHandler), factory.EventMgr_EventHandler);
		...
		DelegateTraits<EventMgr.EventHandler>.Init(factory.EventMgr_EventHandler);
		...
		TypeTraits<EventMgr.EventHandler>.Init(factory.Check_EventMgr_EventHandler);
		...
		StackTraits<EventMgr.EventHandler>.Push = factory.Push_EventMgr_EventHandler;
	...
	class EventMgr_EventHandler_Event : LuaDelegate
	{
		public EventMgr_EventHandler_Event(LuaFunction func) : base(func) { }
		public EventMgr_EventHandler_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public EventMgr.EventHandler EventMgr_EventHandler(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			EventMgr.EventHandler fn = delegate(object[] param0) { };
			return fn;
		}

		if(!flag)
		{
			EventMgr_EventHandler_Event target = new EventMgr_EventHandler_Event(func);
			EventMgr.EventHandler d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			EventMgr_EventHandler_Event target = new EventMgr_EventHandler_Event(func, self);
			EventMgr.EventHandler d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_EventMgr_EventHandler(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(EventMgr.EventHandler), L, pos);
	}

	void Push_EventMgr_EventHandler(IntPtr L, EventMgr.EventHandler o)
	{
		ToLua.Push(L, o);
	}
