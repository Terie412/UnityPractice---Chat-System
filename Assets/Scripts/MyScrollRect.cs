...
public class MyScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
{
    ...
    public virtual void Rebuild(CanvasUpdate executing)  // 接口 ICanvasElement 
    {
    ...
    public virtual void LayoutComplete() { } // 接口 ICanvasElement

    public virtual void GraphicUpdateComplete() { } // 接口 ICanvasElement 
    ...
    public virtual void OnScroll(PointerEventData data) // 接口 IScrollHandler 
    {
        if (!IsActive())
            return;
    ...
    public virtual void OnInitializePotentialDrag(PointerEventData eventData) // 接口 IInitializePotentialDragHandler 
    {
    ...
    public virtual void OnBeginDrag(PointerEventData eventData) // 接口 IBeginDragHandler 
    {
        if (eventData.button != PointerEventData.InputButton.Left)
            return;
    ...
    public virtual void OnEndDrag(PointerEventData eventData) // 接口 IEndDragHandler 
    {
        if (eventData.button != PointerEventData.InputButton.Left)
            return;
    ...
    public virtual void OnDrag(PointerEventData eventData) // 接口 IDragHandler 
    {
        if (!m_Dragging)
            return;
